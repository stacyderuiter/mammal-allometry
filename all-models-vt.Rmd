...
pub_models <- data.frame(mass = seq(from = 0.008, by = 0.1, to = 5200)) %>%
...
```{r, vt-re-predictions-interactive, fig.cap = 'Observed and predicted tidal volume as a function of mass and habitat. Lines are model predictions, points are observed data, and shaded areas are 95% confidence intervals. Colored lines are predictions from the mixed-effects model, green for terrestrial and blue for aquatic; black solid line is based on Stahl (1967) and black dashed line on Fahlman (2020).', fig.width = 6.5, fig.height = 3.5}
