...
author: "Fahlman and DeRuiter labs"
date: "`r Sys.Date()`"
output:
  pdf_document:
    fig_width: 7
...
require(car) # for ANOVA for pgls
require(carEx)  #  needed for Anova(), avPlots, vif functions
...
require(lme4) # for bootMer
require(purrr) # for map() functions
