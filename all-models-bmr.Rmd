...
```{r, re-predictions-by-habitat, fig.cap = 'Observed and predicted BMR as a function of mass and diet. Lines are model predictions, points are observed data, and shaded areas are 95% confidence intervals. Colored lines are predictions from the mixed-effects model, and black line is based on Kleiber (1947).', fig.width = 8.5, fig.height = 3.5}
mammal_bmr <- mammal_bmr %>%
...
pub_models <- data.frame(mass = seq(from = 0.001, by = 0.1, to = 5000)) %>%
