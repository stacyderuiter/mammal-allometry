...
```{r, figure-2f, fig.show = 'hide', dev = 'jpeg', fig.cap = 'Predicted cardiac output as a function of mass and habitat. Colored dots with error bars are mean values and percentile-based 95 percent confidence intervals from parametric bootstrap. Black solid line is based on Stahl (1967).'}
cardiac_mass_log |>
  gf_labs(tag = 'F')
```
...
```{r, figure-2g, fig.show = 'hide', dev = 'jpeg', fig.cap = 'Predicted ventilation as a function of mass and habitat. Colored dots with error bars are mean values and percentile-based 95 percent confidence intervals from parametric bootstrap. Black solid line is based on Stahl (1967).'}
vent_mass_log |>
  gf_labs(tag = 'G')
```
